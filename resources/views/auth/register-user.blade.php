<x-authentication-layout>
    <h1 class="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">{{ __('¡Registro VisualApp!') }} ✨</h1>
    <!-- Form -->
    ...
    <div class="pt-5 mt-6 border-t border-slate-200">
        <div class="text-sm">
            {{ __('Ya tienes cuenta?') }} <a class="font-medium text-indigo-500 hover:text-indigo-600" href="{{ route('login') }}">{{ __('Iniciar sesión') }}</a>
        </div>
    </div>
</x-authentication-layout>
